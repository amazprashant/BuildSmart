...
export default function HomePage() {
  ...
  return (
    <div className="min-h-screen bg-gray-950 text-white">
      ...
      {/* ── Hero ── */}
      <section className="relative overflow-hidden py-24 px-6 border-b border-gray-800">
        <div className="absolute inset-0 bg-gradient-to-br from-blue-950/40 via-gray-950 to-purple-950/30 pointer-events-none" />
        <div
        ...
        <div className="relative max-w-3xl mx-auto text-center">
          <div className="inline-flex items-center gap-2 bg-blue-950/80 border border-blue-800/60 text-blue-300 text-xs font-medium px-3 py-1.5 rounded-full mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
          ...
          {TOPICS.map((topic) => (
            <Link
              ...
              className="group bg-gray-900 border border-gray-800 rounded-xl p-6 hover:border-blue-700/60 hover:shadow-xl hover:shadow-blue-950/30 transition-all duration-200"
            >
              <div className="flex items-start justify-between mb-4">
                <span className="text-3xl">{topic.icon}</span>
                <span className="text-xs bg-emerald-950 text-emerald-400 border border-emerald-800/60 px-2.5 py-0.5 rounded-full font-medium">
                  Available
                </span>
              </div>
          ...
          {COMING_SOON.map((item) => (
            <div
              key={item.title}
              className="bg-gray-900/40 border border-gray-800/40 rounded-xl p-6 opacity-50 select-none"
            >
              <div className="flex items-start justify-between mb-4">
                <span className="text-3xl grayscale">{item.icon}</span>
                <span className="text-xs bg-gray-800 text-gray-500 border border-gray-700 px-2.5 py-0.5 rounded-full font-medium">
                  Coming Soon
                </span>
              </div>
